...
def setup_example_household():
    ...
    hh2 = Household("HouseHold (D)", 70000, 40000, 130)
    hh2.pets.append(Pet("Bob - Cat", 2000, 0.5, 10, 15))
    hh2.humans.append(Human("Linda", 10, 93, 80))
    hh2.humans[0].experience.append("Bob - Cat")
